...
<body class="bg-dark">
    ...
    <jsp:include page="../templates/menuAdmin.jsp"/>
    <jsp:include page="../templates/languageSelect.jsp"/>

    <main>

        <div onclick="document.location='http://localhost:8080/admin/students'"
        ...
        <div onclick="document.location='http://localhost:8080/admin/tests'"
             class="card text-white bg-dark mb-3 onclick-anim" style="max-width: 18rem;">
