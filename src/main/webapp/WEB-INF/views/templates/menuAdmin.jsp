<%@ include file="libsAndLocale.jspf" %>

<nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/admin">
            <img src="../../../images/testingUA.png" alt="logo" style="width: 40px">
            TestingUA <span style="color: #ababab; padding-left: 5px;">(<fmt:message key="admin"/>)</span>
        </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/admin/tests">
                        <fmt:message key="menu.tests"/>
